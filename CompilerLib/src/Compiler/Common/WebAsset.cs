...
namespace Compiler.Common
{
    public abstract class WebAsset
    {
        ...
        public static WebAsset FromString(string filepath)
        {
            ...
            {
                case ".css": return new WebAssetStyleSheet(filepath, "css/" + fileName);
                case ".js": return new WebAssetJavaScript(filepath, "js/" + fileName);
                default: return new WebAssetUnknown();
            }
        }
